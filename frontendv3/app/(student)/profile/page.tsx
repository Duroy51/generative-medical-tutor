...
import {
    ...
    CheckCircle, ListTodo, Shield, Star, Activity, ChevronLeft // <--- IMPORT ICÔNE
} from 'lucide-react';
...
export default function ProfilePage() {
    ...
    const skillValues = Object.values(skills).map((s:any) => s.level);
    const avgLevel = skillValues.length ? (skillValues.reduce((a:any, b:any) => a + b, 0) / skillValues.length).toFixed(1) : 0;
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FC] pb-20">
            ...
            <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
                ...
                {/* 1. CARTE D'IDENTITÉ */}
                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl shadow-brand-primary/5 flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    {/* 2. DÉTAIL DES COMPÉTENCES (Gauche) */}
